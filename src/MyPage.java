...
public class MyPage extends JFrame {
	...
	public MyPage() throws Exception {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(MyPage.class.getResource("/images/money-bag.png")));
		...
		label.setIcon(new ImageIcon(MyPage.class.getResource("/images/Bank-logo.png")));
		label.setBounds(5, 11, 300, 69);
		...
		lblUser.setBounds(245, 11, 36, 18);
		panel.add(lblUser);
		...
		lblCopyrights.setBounds(660, 528, 200, 16);
