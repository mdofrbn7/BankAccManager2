...
public class Loading extends JFrame {
	...
	public Loading() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Loading.class.getResource("/images/money-bag.png")));
		...
		panel.setBorder(new TitledBorder(new LineBorder(new Color(107, 109, 140), 3), "My Page", TitledBorder.LEADING, TitledBorder.TOP, new Font("Tahoma", Font.PLAIN, 24), new Color(91, 103, 245)));
		panel.setBounds(13, 11, 320, 370);
		contentPane.add(panel);
		panel.setLayout(null);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setBounds(10, 29, 300, 78);
		panel.add(lblNewLabel);
		lblNewLabel.setIcon(new ImageIcon(Loading.class.getResource("/images/Bank-logo.png")));
		
		progressBar = new JProgressBar();
		progressBar.setBounds(40, 118, 226, 34);
		...
		lblNewLabel_1.setBounds(100, 163, 105, 19);
		panel.add(lblNewLabel_1);
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setBounds(70, 186, 176, 165);
		...
		lblNewLabel_3.setBounds(30, 392, 269, 14);
		...
		JLabel lblNewLabel_6 = new JLabel("Copyrights(c) name.");
		lblNewLabel_6.setHorizontalAlignment(SwingConstants.TRAILING);
		lblNewLabel_6.setFont(new Font("Tahoma", Font.PLAIN, 10));
                lblNewLabel_6.setForeground(Color.red);
		lblNewLabel_6.setBounds(125, 461, 205, 19);
		...
		lblNewLabel_7.setBounds(230, 477, 107, 14);
