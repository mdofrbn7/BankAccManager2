...
public class Create_account extends JFrame {
	...
	public Create_account() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Create_account.class.getResource("/images/money-bag.png")));
		setAlwaysOnTop(true);
		setResizable(false);
		...
		label.setIcon(new ImageIcon(Create_account.class.getResource("/images/Bank-logo.png")));
		label.setBounds(2, 8, 300, 70);
		...
		JLabel lblNewLabel_5 = new JLabel("Thanks for Banking with us!");
		lblNewLabel_5.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblNewLabel_5.setForeground(new Color(255, 69, 0));
		lblNewLabel_5.setBounds(278, 477, 190, 25);
		...
		panel.setBorder(new TitledBorder(new LineBorder(new Color(107, 109, 140), 3), "Create Bank Account", TitledBorder.LEADING, TitledBorder.TOP, new Font("Tahoma", Font.PLAIN, 24), new Color(91, 103, 245)));
